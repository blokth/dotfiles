...
-- Keymap to deal with system clipboard
vim.keymap.set({ "n", "x" }, "cp", '"+y')
vim.keymap.set({ "n", "x" }, "cv", '"+p')

-- Remap for x not copying after delete
...
-- Keymap to switch between most recent buffers
...
-- [[ Quit with "q" in man, help ]]
local man_group = vim.api.nvim_create_augroup("ManGroup", { clear = true })
